function [exclayer,motorlayer,inhlayer,readout] = HH_FD_exp(options)
arguments
...
for l = 1:totlayer
    ...
    for i = 2:step
        ...
        Isyn = exce*exclayer(l).output(i-1).*(v-Ve)/neuron + ort.*(v-Vi);
    ...
    for i = 2:step
        ...
        Isyn =(1-cas9)*glue*motorlayer(l).output(i-1).*(v-Vi);
